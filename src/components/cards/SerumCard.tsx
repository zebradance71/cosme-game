...
export function SerumCard({ skin, selectedSerum, disabled, isApplying, onSelect }: SerumCardProps) {
  ...
  const skinImageLayouts: Partial<Record<SkinType, SkinImageLayout>> = {
    dry: {
      ...
      hotspots: [
        { serum: 'retinol', left: '2%', top: '66%', width: '18.8%', height: '31.5%' },
        { serum: 'vitamin_c', left: '21.4%', top: '66%', width: '18.8%', height: '31.5%' },
        { serum: 'niacinamide', left: '40.8%', top: '66%', width: '18.8%', height: '31.5%' },
        { serum: 'ceramide', left: '60.2%', top: '66%', width: '18.8%', height: '31.5%' },
        { serum: 'aha_bha', left: '79.6%', top: '66%', width: '18.8%', height: '31.5%' },
      ],
    },
    oily: {
