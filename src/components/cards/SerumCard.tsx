...
export function SerumCard({ skin, selectedSerum, disabled, isApplying, onSelect }: SerumCardProps) {
  ...
  const skinImageLayouts: Partial<Record<SkinType, SkinImageLayout>> = {
    dry: {
      ...
      hotspots: [
        { serum: 'retinol', left: '2%', top: '67.25%', width: '18.8%', height: '30.95%' },
        { serum: 'vitamin_c', left: '21.4%', top: '67.25%', width: '18.8%', height: '30.95%' },
        { serum: 'niacinamide', left: '40.8%', top: '67.25%', width: '18.8%', height: '30.95%' },
        { serum: 'ceramide', left: '60.2%', top: '67.25%', width: '18.8%', height: '30.95%' },
        { serum: 'aha_bha', left: '79.6%', top: '67.25%', width: '18.8%', height: '30.95%' },
      ],
    },
    oily: {
